...
namespace HostelmanegementSystem
{
    public partial class Message : Form
    {
        ...
        private void Received_Load(object sender, EventArgs e)
        {
            ...
            //this.contactTableAdapter.Fill(this.studentDBAppContact.Contact);
